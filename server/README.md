...
The sync backend: an append-only event log on Cloudflare Workers + D1. Design and
reasoning live in [`../docs/sync-plan.md`](../docs/sync-plan.md).
...
- The server never interprets an event. New event kinds need no change here.
